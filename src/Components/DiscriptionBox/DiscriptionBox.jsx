  ...
  return (
    <div className='discriptionbox'>
        ...
        <div className="discriptionbox-discription">
            <p>An e-commerce website is on online platform that facilitates the buying and selling of products or services over the internet.
            ...
            <p>E-commerce websites typically display products or services along with detailed descriptions, immages, prices, and any available variations
